...
func GetCurrentReminds(w http.ResponseWriter, r *http.Request, db *sql.DB) {
	...
	query := remindsJson.GetCurrentReminds
	...
	var reminds []CurrentReminds
	for rows.Next() {
		var remind CurrentReminds
